...
<<<<<<< HEAD
                ...
                @endif
                <div id="payment-method-error" class="mb-5 hidden rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-700">
                    Please select a payment method.
                </div>
                <div class="flex gap-5 sm:gap-8 md:gap-12 flex-wrap">
                    @forelse($paymentMethods as $methodKey => $method)
...
<<<<<<< HEAD
                    ...
                    @empty
                    <div>
                        <p class="rounded-lg border border-orange-200 bg-orange-50 p-4 text-sm text-orange-700">
                            No payment method is active. Please contact store support.
                        </p>
                    </div>
                    @endforelse
                </div>
