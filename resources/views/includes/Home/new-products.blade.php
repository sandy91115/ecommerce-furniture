        ...
        <div class="relative overflow-hidden">
            <a href="{{ route('product-details', ['slug' => $product->slug]) }}">
                @if($product->images->first())
                    <img class="w-full transform group-hover:scale-110 duration-300" src="{{ asset('storage/' . $product->images->first()->path) }}" alt="{{ $product->name }}">
                @else
                    <img class="w-full transform group-hover:scale-110 duration-300" src="{{ asset('assets/img/no-image.png') }}" alt="{{ $product->name }}">
                @endif
            </a>
        ...
        <div class="md:px-2 lg:px-4 xl:px-6 lg:pt-6 pt-5 flex gap-4 md:gap-5 flex-col">
            ...
            <div>
                <h5 class="font-normal dark:text-white text-xl leading-[1.5]">
                    <a href="{{ route('product-details', ['slug' => $product->slug]) }}" class="text-underline">
                        {{ $product->name }}
                    </a>
                </h5>
