...
<div class="max-w-7xl mx-auto">
    <div class="flex items-center justify-between gap-4 mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Quotation Products</h1>
            <p class="mt-1 text-sm text-gray-600">Manage products available for customer quotations.</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.products.quotation') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 font-medium">
                All Quotation Products
            </a>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right">
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    <a href="/quotation/{{ $product->slug }}" target="_blank" class="inline-flex items-center px-3 py-1.5 rounded-md bg-green-600 text-white hover:bg-green-700 font-medium">
                                        View Form
                                    </a>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-sm text-gray-500">No quotation products found. <a href="{{ route('admin.products.create') }}" class="text-blue-600 hover:text-blue-800 font-medium">Create one</a>.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
