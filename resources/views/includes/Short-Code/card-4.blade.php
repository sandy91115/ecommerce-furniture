...
@foreach ($cards as $item)
    <div>
        <div class="relative overflow-hidden before:absolute card-gradient-overlay before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:opacity-0 hover:before:opacity-100 before:duration-300 group">
            ...
            <div class="absolute z-30 top-[64%] left-[66%] transform -translate-x-2/4 -translate-y-2/4 flex items-center justify-center bg-white dark:bg-title bg-opacity-20 dark:bg-opacity-70 rounded-full p-3 scale-0 group-hover:scale-100 duration-300">
                <div class="w-16 md:w-20 h-16 md:h-20 bg-white rounded-full dark:bg-title flex items-center justify-center">
                    <h4 class="font-normal leading-none dark:text-white text-2xl">{{ $item['price'] }}</h4>
                </div>
            </div>
        </div>
        <h5 class="leading-none font-normal mt-4 md:mt-6 dark:text-white text-xl">{{ $item['title'] }}</h5>
    </div>
@endforeach