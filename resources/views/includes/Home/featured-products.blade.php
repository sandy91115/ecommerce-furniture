...
<div class="featured-products-layout">
    ...
    @endif
=======
<div class="featured-products-grid grid grid-cols-2 sm:grid-cols-2 gap-5 sm:gap-8 lg:max-w-[766px] w-full">
...
<div class="featured-products-grid grid grid-cols-2 sm:grid-cols-2 gap-5 sm:gap-8 lg:max-w-[925px] w-full">
