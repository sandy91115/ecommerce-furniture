    ...
    <div class="bg-white shadow rounded-lg p-8">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
            ...
            @include('admin.seo.partials.advanced-fields', [
                ...
                'titleFallback' => old('meta_title', $category->meta_title),
                'descriptionFallback' => old('meta_description', $category->meta_description),
                'canonicalFallback' => route('shop.category', ['category' => $category->slug]),
