...
@foreach ($portfolios as $item)
    <div class="{{ $item['style'] }}">
        <a href="{{ route('portfolio-details-v2', ['title' => Str::slug($item['title'])]) }}" class="portfolio-card relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-0 before:duration-300 hover:before:opacity-100 group overflow-hidden block">
