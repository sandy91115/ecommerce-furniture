<!-- resources/views/blog-details-v2.blade.php -->
@extends('layouts.main')

@section('title', 'Blog-Details-V2 Page')
...
<div class="mt-14">
    <div class="container-fluid">
        <div class="max-w-[940px] mx-auto" data-aos="fade-up">
            <div>
                <ul class="flex items-center gap-[10px] flex-wrap">
                    ...
                    <li><a href="{{ url('/blog-tag') }}" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum">
                        @if(!empty($item['tag']))
                            {{ $item['tag'] }}
                        @else
                            Interior
                ...
                <h1 class="text-2xl leading-snug sm:text-3xl sm:leading-snug md:text-[40px] mt-4 md:mt-6 md:leading-snug font-bold">
                    @if(!empty($item['title']))
                        {{ $item['title'] }}
                    @else
                        How to Choose the Perfect Sofa for Living Room
                    @endif
                </h1>
                <!-- Author -->
        ...
        @php
            $imagePath = !empty($item['img']) ? asset($item['img']) : asset('assets/img/thumb/blog-details.jpg');
        @endphp

        <img class="{{ !empty($item['img']) ? 'w-full max-w-[800px] mx-auto' : '' }}" src="{{ $imagePath }}" alt="blog">
        ...
        <div class="max-w-[1140px] mx-auto px-5 sm:px-[50px] md:px-[70px] lg:px-24 bg-white dark:bg-title blog-details-wrapper -mt-3 lg:-mt-12 relative z-10 rounded-xl sm:rounded-[20px] pt-8 md:pt-10">
            ...
            <div class="s-py-50 flex justify-between flex-col md:flex-row gap-8 md:gap-6" data-aos="fade-up">
                <div class="md:max-w-[390px] w-full">
                        ...
                        <a href="{{ url('/blog-details-v1') }}" class="max-w-[80px] h-auto sm:max-w-[114px] w-full flex-none block">
                            <img class="w-full h-full object-cover" src="{{ asset('assets/img/blog-details/post-01.jpg') }}" alt="post">
                        </a>
                        <div class="flex-1">
                            <ul class="flex items-center gap-[10px] flex-wrap">
                            ...
                            <h5 class="mt-3 font-medium dark:text-white leading-[1.5] text-xl"><a href="{{ url('/blog-details-v1') }}" class="text-underline">Consectetur purus habitasse ut diam habitant varius.</a></h5>
                        </div>
                        </div>
                </div>
                <div class="md:max-w-[390px] w-full">
                    ...
                    <div class="group flex sm:items-center gap-[15px]">
                        <a href="{{ url('/blog-details-v3') }}" class="max-w-[80px] h-auto sm:max-w-[114px] w-full flex-none block">
                            <img class="w-full h-full object-cover" src="{{ asset('assets/img/blog-details/post-02.jpg') }}" alt="post">
                        </a>
                        <div class="flex-1">
                            <ul class="flex items-center gap-[10px] flex-wrap">
                                <li class="text-[15px] leading-none dark:text-white">6 Sep, 2025</li>
                            ...
                            <h5 class="mt-3 font-medium dark:text-white text-xl"><a href="{{ url('/blog-details-v3') }}" class="text-underline">How to Choose the Perfect Sofa for Living Room </a></h5>
                        </div>
                    </div>
                </div>
            </div>
