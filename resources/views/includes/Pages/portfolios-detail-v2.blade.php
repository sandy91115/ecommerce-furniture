...
@foreach ($portfolios as $item)
    <a href="{{ route('portfolio-details-v2', ['title' => Str::slug($item['title'])]) }}" class="portfolio-card relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-100 before:duration-300 group overflow-hidden block">
