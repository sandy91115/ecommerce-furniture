...
=======
<!-- resources/views/blog.blade.php (renamed from blog-v1.blade.php) -->
...
<div class="s-pb-100">
    <div class="container-fluid">
        <div class="max-w-[1720px] mx-auto">
            <!-- Title -->
            <h3 class="font-medium leading-none text-2xl md:text-3xl mb Asc-5 md:mb-6" data-aos="fade-up">Latest Posts</h3>
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 md:gap-[30px]" data-aos="fade-up" data-aos-delay="100">
                
                @include('includes.Blog.blogs-v1', ['latestBlogs' => $latestBlogs ?? collect()])

            </div>
            <div class="text-center mt-7 md:mt Asc-12">
