...
<div class="grid gap-[30px]">
        ...
        @foreach ($arrivals as $item)
            <div class="group flex flex-col">
                <div class="relative overflow-hidden flex-1">
                    <img class="w-full transform duration-300 group-hover:scale-110 h-full object-cover" src="{{ asset($item['img']) }}" alt="product-card">
                    ...
                    <div class="absolute z-10 top-[58%] left-[80%] transform -translate-y-2/4 -translate-x-2/4 flex gap-2">
                        ...
                        <a href="{{ url('/cart') }}" class="w-9 lg:w-12 h-9 p-2 lg:h-12 bg-white dark:bg-title bg-opacity-80 flex items-center justify-center transform translate-y-8 opacity-0 transition-all group-hover:duration-500 group-hover:opacity-100 group-hover:translate-y-0 relative tooltip-icon rounded-full">
    ...
    <!-- Product -->
    <div class="relative">
        <img class="w-full object-cover" src="{{ asset('assets/img/home-v2/arrival-01.jpg') }}" alt="arrival">
        <div class="absolute z-10 bg-white bg-opacity-50 dark:bg-title dark:bg-opacity-50 p-5 md:p-[30px] top-5 sm:top-8 md:top-12 right-5 sm:right-8 md:right-12">
            ...
            <a class="btn btn-outline mt-4 md:mt-6" href="{{ url('/shop-v2') }}" data-text="See all Productss"><span>See all Productss</span></a>
        </div>
    </div>
</div>
<div class="flex flex-col-reverse lg:grid gap-[30px]">
    <!-- Product -->
    <div class="relative">
        <img class="w-full object-cover" src="{{ asset('assets/img/home-v2/arrival-02.jpg') }}" alt="arrival">
        <div class="absolute z-10 bg-white bg-opacity-50 dark:bg-title dark:bg-opacity-50 p-5 md:p-[30px] top-5 sm:top-8 md:top-12 right-5 sm:right-8 md:right-12">
            ...
            <a class="btn btn-outline mt-4 md:mt-6" href="{{ url('/shop-v2') }}" data-text="See all Products"><span>See all Products</span></a>
        </div>
    </div>
    <div class="grid sm:grid-cols-2 gap-[30px]">
        
        @foreach ($arrivals1 as $item)
            <!-- Single Product -->
            <div class="group flex flex-col">
                <div class="relative overflow-hidden flex-1">
                    <img class="w-full transform duration-300 group-hover:scale-110 h-full object-cover" src="{{ asset($item['img']) }}" alt="product-card">
