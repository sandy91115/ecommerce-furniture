<!-- Footer Area Start -->
@php
    $siteLogoPath = \App\Models\Setting::get(\App\Models\Setting::SITE_LOGO_PATH);
    $footerLogoUrl = $siteLogoPath ? asset('storage/' . $siteLogoPath) : asset('assets/img/footer-logo.svg');

    $quickLinks = collect($menus['footer_sitemap'] ?? [])->concat(collect($menus['footer_others'] ?? []));
    $shopLinks = collect($menus['footer_shop'] ?? []);
    $serviceLinks = collect($menus['footer_service'] ?? []);
@endphp

<div class="site-footer-light s-pt-100 bg-snow dark:bg-title 2xl:pb-[70px]">
    <div class="container-fluid max-w-[1720px] mx-auto">
        <div class="footer-layout">
            <div class="footer-brand">
                <div class="footer-brand-row">
                    <a href="{{ url('/') }}" class="footer-brand__logo" aria-label="Carom Studios home">
                        <img class="footer-logo object-contain " src="{{ $footerLogoUrl }}" alt="CAROM STUDIOS"
                            onerror="this.onerror=null; this.src='{{ asset('assets/img/footer-logo.svg') }}';">
                    </a>

                    <div class="footer-brand__content">
                        <p class="text-title dark:text-white">
                            Carom studios is a modern furniture for an eCommerce website designed to help you create an
                            impressive online store for your furniture or home decor business.
                        </p>
...
<div class="footer-links grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="footer-column">
                    ...
                    <ul class="text-title dark:text-white leading-none space-y-3">
                        ...
                        @else
                            ...
                            <li class="duration-100 hover:text-secondary block group"><a
                                    class="text-underline-secondary" href="{{ url('/privacy-policy') }}">Privacy Policy</a>
                            </li>
                            <li class="duration-100 hover:text-secondary block group"><a
                                    class="text-underline-secondary" href="{{ url('/contact') }}">Contact</a></li>
                        @endif
                ...
                <div class="footer-column footer-column--contact">
                    ...
                    <ul class="footer-contact-list text-title leading-none space-y-3">
                        <li class="footer-contact-item duration-100 hover:text-secondary group flex items-start gap-2">
                            <svg class="w-5 h-5 fill-current text-[#5B646D] duration-300 flex-shrink-0 mt-0.5" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                            </svg>
                            <a class="text-underline-secondary text-sm" href="mailto:caromstudios@gmail.com">caromstudios@gmail.com</a>
                        </li>
                        <li class="footer-contact-item duration-100 hover:text-secondary group flex items-start gap-2">
                            <svg class="w-5 h-5 fill-current text-[#5B646D] duration-300 flex-shrink-0 mt-0.5" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="text-underline-secondary text-sm" href="tel:+919205100855">+91 9205100855</a>
                        </li>
                        <li class="footer-contact-item duration-100 hover:text-secondary group flex items-start gap-2">
                            <svg class="w-5 h-5 fill-current text-[#5B646D] duration-300 flex-shrink-0 mt-0.5" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
