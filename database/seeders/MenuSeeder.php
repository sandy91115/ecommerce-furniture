...
class MenuSeeder extends Seeder
{
    public function run()
    {
        $types = [
            ...
            ['menu_type' => 'admin_sidebar', 'title' => 'Dashboard', 'url' => '/admin/dashboard', 'order' => 1],
            ['menu_type' => 'admin_sidebar', 'title' => 'Categories', 'url' => '/admin/categories', 'order' => 2],
            ['menu_type' => 'admin_sidebar', 'title' => 'Products', 'url' => '/admin/products', 'order' => 3],
            ['menu_type' => 'admin_sidebar', 'title' => 'Attributes', 'url' => '/admin/attributes', 'order' => 4],
            ['menu_type' => 'admin_sidebar', 'title' => 'Orders', 'url' => '/admin/orders', 'order' => 5],
            ['menu_type' => 'admin_sidebar', 'title' => 'Users', 'url' => '/admin/customers', 'order' => 6],
            ['menu_type' => 'admin_sidebar', 'title' => 'Coupons', 'url' => '/admin/coupons', 'order' => 7],
            ['menu_type' => 'admin_sidebar', 'title' => 'Blog', 'url' => '/admin/blogs', 'order' => 8],
            ['menu_type' => 'admin_sidebar', 'title' => 'CMS', 'url' => '/admin/cms', 'order' => 9],
            ['menu_type' => 'admin_sidebar', 'title' => 'Settings', 'url' => '/admin/settings', 'order' => 10],
            ['menu_type' => 'admin_sidebar', 'title' => 'Menus', 'url' => '/admin/menus', 'order' => 11],
