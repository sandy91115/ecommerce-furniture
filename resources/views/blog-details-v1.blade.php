...
=======
                            ...
                            <h5 class="mt-3 font-medium dark:text-white leading-[1.5] text-xl"><a href="{{ route('blog.show', $prevBlog->slug) }}" class="text-underline">{{ Str::limit($prevBlog->title, 50) }}</a></h5>
>>>>>>> a4263c56a3ac3187932f99434605d5942427c646
                        </div>
                        @else
...
=======
                            ...
                            <h5 class="mt-3 font-medium dark:text-white leading-[1.5] text-xl"><a href="{{ route('blog.show', $nextBlog->slug) }}" class="text-underline">{{ Str::limit($nextBlog->title, 50) }}</a></h5>
>>>>>>> a4263c56a3ac3187932f99434605d5942427c646
                        </div>
                        @else
                        <div class="w-[80px] h-[80px] bg-gray-200 flex items-center justify-center rounded">No Image</div>
