...
<div class="home-new-product-card group">
    ...
    <div class="home-new-product-card__content">
        @if($product->product_type === 'quotation')
            <span
                class="inline-flex w-max items-center rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">Quotation
                Product</span>
        @endif
        ...
        <div>
            ...
            <ul class="home-new-product-card__rating flex items-center gap-2 mt-1">
                ...
                <li>
                    <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.1622 13.6923L7.181 11.201L3.19978 13.6922C3.05515 13.7839 2.86858 13.7769 2.72931 13.6758C2.59043 13.5751 2.52673 13.4001 2.56864 13.2337L3.70764 8.67717L0.150459 5.6612C0.0189569 5.55107 -0.0324041 5.37191 0.0206119 5.2088C0.0736279 5.04526 0.220726 4.93062 0.391668 4.9187L5.03447 4.59449L6.79065 0.23853C6.91968 -0.0
                    </svg>
                </button>

                <button
                    type=" button" class="quick-view home-new-product-card__action"
