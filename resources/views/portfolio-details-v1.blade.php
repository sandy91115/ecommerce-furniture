<!-- resources/views/portfolio-details-v1.blade.php -->
@extends('layouts.main')

@section('title', 'Portfolio-Details-V1 Page')
    ...
    <div class="container-fluid">
        <div class="div flex flex-col-reverse md:flex-row gap-8 lg:gap-16 justify-between">
            <div class="grid gap-y-7 w-full flex-1">
                <div class="div">
                    <img class="w-full" src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/img/gallery/portfolio-03/portfolio-01.jpg') }}" alt="Portfolio">
                </div>
                <div class="div">
    ...
    <div class="container-fluid">
        <div class="max-w-[1720px] mx-auto">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-[30px]">
                ...
                <!-- includes/Pages/portfolios-detail-v1.blade.php -->
                @include('includes.Pages.portfolios-detail-v1')
