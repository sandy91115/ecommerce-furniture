                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <button class="p-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-all wishlist-toggle {{ $isInWishlist ? 'added' : '' }}" data-product-id="{{ $product->id }}" title="{{ $isInWishlist ? 'Remove from wishlist' : 'Add to wishlist' }}" aria-pressed="{{ $isInWishlist ? 'true' : 'false' }}">
                                <svg class="w-5 h-5 {{ $isInWishlist ? 'text-red-500' : 'text-gray-600 hover:text-red-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
