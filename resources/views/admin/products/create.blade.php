...
@enderror
                ...
                <div>
                    ...
                    <input type="number" name="product_rating_count" min="0" value="{{ old('product_rating_count') }}" placeholder="Optional" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('product_rating_count') border-red-500 @enderror">
 ...
 <div>
            ...
            @include('admin.seo.partials.advanced-fields', [
                ...
                'titleFallback' => old('seo_title'),
                'descriptionFallback' => old('seo_description'),
                'canonicalFallback' => '',
                'schemaType' => 'Product',
            ])
            ...
            <div class="mt-6">
                ...
                <textarea id="shipping_details" name="shipping_details" rows="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('shipping_details') border-red-500 @enderror">{{ old('shipping_details') }}</textarea>
